...
export default function MainPhoto () {
    ...
    function changeLike(dataId) {
        // e.target.classList.toggle('orange600')
        // console.log(dataId);
        console.log('hstr',history);
        const temaHistory = history.map(elem => {
            console.log(elem);
            if(elem.id == dataId) {
                console.log('finded');
                return elem.liked_by_user = !elem.liked_by_user
            }
        })
                ...
                !!data && (
                    <div className="main-box">
                        ...
                        <div className="likes-box">
                            <i onClick={() => changeLike(data.id)} id="material-icons" data-id={data.id}  className="material-icons" >
                                favorite_border
                            </i>
                            <p>{data.likes}</p>
                        </div>
