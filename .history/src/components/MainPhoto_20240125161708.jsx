...
export default function MainPhoto () {
    ...
    return (
        <div className="container">
            <h4>Main Photo</h4>
            {
                loading ? <Preloader /> : (data && <div className="main-picture">
                    <img className="main-picture" src={data.urls.regular} alt="picture" />
                </div> ) 
            }
            {
                loading ? <Preloader /> : (data && <div className="likes-box">
