...
export default function MainPhoto () {
    ...
    function changeLike(e, dataId, likes) {
        isClicked = e.target.classList.contains('orange600');
                ...
                !!data && (
                    <div className="main-box">
                        ...
                        <div className="likes-box">
                            <i onClick={(e) => changeLike(e, data.id, data.likes)} id="material-icons"  className={`material-icons ${data.liked_by_user ? "orange600" : " "}`} >
                                favorite_border
                            </i>
                            <p>{data.likes}</p>
                        </div>
